...
class EmbeddedTomcat {
    ...
    private static final String WEB_APP_DIR = "app-war/src/main/webapp/";
    private static final String WEB_APP = "/WEB-INF/classes";
    ...
    void deploy() throws ServletException {
        ...
        File additionWebInfClasses = new File("controller/target/classes");
        WebResourceRoot resources = new StandardRoot(ctx);
        resources.addPreResources(new DirResourceSet(resources, WEB_APP, additionWebInfClasses.getAbsolutePath(),
                INTERNAL_PATH));
